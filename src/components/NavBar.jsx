  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-10 py-5 -translate-y-6">
        <a className="block w-[12rem] xl:mr-8 cursor-pointer" onClick={() => navigate("/")}>
        ...
        {!auth.isAuthenticated && (
          <Button className="hidden lg:flex bg-gradient-to-r from-n-3 to-n-4 rounded-2xl border border-l-2 border-l-n-2" onClick={() => navigate("/sign_in")}>
            Log in
          </Button>
        )}
        {auth.isAuthenticated && (
